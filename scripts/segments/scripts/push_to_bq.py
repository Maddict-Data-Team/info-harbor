...
def create_Combined_table(country):
    ...
    try:
        ...
        print(f"{code_name}_{country}_Segments was already created. If not intended, delete the table and run again")

def insert_to_combined(table_name):
...
def create_external_table(file_id, table_name):
